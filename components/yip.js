...
var growlgntp = {
  ...
  register : function(){
    // get the icon path
    var id = "silentdivingseagulls@abi.sh";
    var extension = Cc["@mozilla.org/extensions/manager;1"]
                    .getService(Ci.nsIExtensionManager)
                    .getInstallLocation(id)
                    .getItemLocation(id);
    var icon = extension.path + "\\content\\images\\icon.jpg";
...
Yip.prototype = {
  ...
  displayNotification : function(aNotifyObject){
    ...
    var icon = aNotifyObject.icon ? aNotifyObject.icon : "chrome://silentdivingseagulls/content/images/icon-32.jpg";
    ...
    if(osString == "WINNT"){
      ...
      if(Application.prefs.getValue(GFW_PREF, false)){
        try{
          ...
          if(icon == "chrome://silentdivingseagulls/content/images/icon-32.jpg"){
            tempIcon = iconPath;
          }else{
            tempIcon = icon;
          }
